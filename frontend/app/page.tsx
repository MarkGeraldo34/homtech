    ...
    <div className="space-y-16">
      <div className="space-y-6">
        ...
        <p className="text-muted">
          ...
          cross-chain wallet activity and an owned Ethereum-mainnet NFT — that same NFT is what
          gets locked as collateral. Lenders fund a shared pool per tier and earn a streaming
          reward token until borrowers repay.
        </p>
